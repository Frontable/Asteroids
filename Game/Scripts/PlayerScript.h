...
public:
    ...
    void OnUpdate(float dt) override
    {
        ...
        // thrust — offset by 90 degrees so sprite points up on start, 
        // TODO: future will make this as option when creating the entity
