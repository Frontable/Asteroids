...
inline Sprite GetSprite(SpriteID id)
{
    ...
    case SpriteID::ASTEROID_SMALL_TOP_RIGHT_TOP_LEFT:
        return { {221.0f, 192.0f}, {12.0f, 9.0f} };
    ...
    case SpriteID::POWERUP_SHIELD:
        return { {0.0f, 0.0f}, {16.0f, 16.0f} };
    case SpriteID::POWERUP_RAPIDFIRE:
        return { {16.0f, 0.0f}, {16.0f, 16.0f} };
    case SpriteID::POWERUP_SPEED:
        return { {32.0f, 0.0f}, {16.0f, 16.0f} };
